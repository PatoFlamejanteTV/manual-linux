...
Caso você tenha pouca memória RAM em seu computador, você pode tentar aumentar/criar uma partição/arquivo `swap`, pra caso a memória RAM "encha" até o limite, um pouco é passado pro SWAP de forma que seu sistema não pare do nada.
