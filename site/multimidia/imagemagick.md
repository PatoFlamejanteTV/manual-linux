...
```
02:16:05 quack@quack manual-linux ±|main✔|→ sudo apt install imagemagick
[sudo] senha para quack:
imagemagick já é a versão mais nova (8:7.1.1.43+dfsg1-1+deb13u3).
imagemagick configurado para instalar manualmente.
Resumo:
  Atualizando: 0, Instalando: 0, Removendo: 0, Não atualizando: 0
02:16:13 quack@quack manual-linux ±|main✔|→ imagemagick
imagemagick: comando não encontrado
02:16:16 quack@quack manual-linux ±|main✔|→ convert
...
convert: missing required argument  @ error/deprecate.c/ConvertImageCommand/569.
02:16:23 quack@quack manual-linux ±|main✔|→
```
