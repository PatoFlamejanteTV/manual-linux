...
No contexto da computação, "binário" pode se referir a duas coisas principais:

1.  **O Sistema Numérico Binário:** A base de toda a computação moderna, composta apenas por 0s e 1s.
2.  **Arquivos Executáveis:** Frequentemente chamados de "binários", são arquivos compilados (traduzidos de código-fonte para linguagem de máquina) que o computador pode executar diretamente.
